...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/luisetecoind.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/luisetecoin-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/luisetecoin-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/pivx.ico %{buildroot}%{_datadir}/pixmaps/luisetecoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/luisetecoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/luisetecoin2.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/luisetecoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/luisetecoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/luisetecoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/luisetecoin256.png %{buildroot}%{_datadir}/pixmaps/luisetecoin6.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/luisetecoin256.png %{buildroot}%{_datadir}/pixmaps/luisetecoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/luisetecoin56.png %{buildroot}%{_datadir}/pixmaps/luisetecoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/pivx256.png %{buildroot}%{_datadir}/pixmaps/luisetecoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/luisetecoin56.png %{buildroot}%{_datadir}/pixmaps/luisetecoin256.xpm
