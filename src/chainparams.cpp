...
{
    const char* pszTimestamp = "Si vienes a campa, estas basicamente muerto";
...
public:
    CMainParams()
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000001b7dcecd252bff0d2e60c5fdf36b9c0a2ee7ae3b415dc37b02e38f1b63d"));
        assert(genesis.hashMerkleRoot == uint256S("0x8b02e632622b9fc1686739e15af15b1a4aed830f2353c4b731f65693c40a1e91"));
        ...
        vSeeds.push_back(CDNSSeedData("seeder", "185.207.104.251"));
	    vSeeds.push_back(CDNSSeedData("seed1", "185.194.141.200"));
        vSeeds.push_back(CDNSSeedData("seed2", "5.45.107.126"));
